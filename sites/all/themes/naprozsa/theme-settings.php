 ...
 */
function naprozsa_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['naprozsa_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('naprozsa sample setting'),
  '#default_value' => theme_get_setting('naprozsa_example'),
